...
public class DatabaseConfig {
	...
	private static final String DB_PASSWORD = System.getenv().getOrDefault("DB_PASSWORD", "Jason050604_");
	...
	public static void runMigrations() {
		try {
			...
			Liquibase liquibase = new Liquibase(
					"db/changelog/db.changelog-master.xml", new ClassLoaderResourceAccessor(),
					database);
